...
export namespace Prisma {
  ...
  */
  ...
  > = {
     ...
     */
    orderBy?:
      | AppUserOrderByWithRelationInput
      | AppUserOrderByWithRelationInput[];
    /**
  ...
  > = {
    where?: AppUserWhereInput;
    orderBy?:
      | AppUserOrderByWithAggregationInput
      | AppUserOrderByWithAggregationInput[];
  ...
  type GetAppUserGroupByPayload<T extends AppUserGroupByArgs> =
  ...
  type AppUserGetPayload<
    S extends boolean | null | undefined | AppUserDefaultArgs,
  > = $Result.GetResult<Prisma.$AppUserPayload, S>;

  type AppUserCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  ...
  > {
    ...
    findFirst<T extends AppUserFindFirstArgs>(
      ...
      $Result.GetResult<Prisma.$AppUserPayload<ExtArgs>, T, "findFirst"> | null,
      null,
      ExtArgs
    >;
    ...
    findFirstOrThrow<T extends AppUserFindFirstOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$AppUserPayload<ExtArgs>, T, "findFirstOrThrow">,
      never,
      ExtArgs
    >;
    ...
    findMany<T extends AppUserFindManyArgs>(
      ...
      $Result.GetResult<Prisma.$AppUserPayload<ExtArgs>, T, "findMany">
    >;
    ...
    create<T extends AppUserCreateArgs>(
      ...
      $Result.GetResult<Prisma.$AppUserPayload<ExtArgs>, T, "create">,
      never,
      ExtArgs
    >;
    ...
    delete<T extends AppUserDeleteArgs>(
      ...
      $Result.GetResult<Prisma.$AppUserPayload<ExtArgs>, T, "delete">,
      never,
      ExtArgs
    >;
    ...
    update<T extends AppUserUpdateArgs>(
      ...
      $Result.GetResult<Prisma.$AppUserPayload<ExtArgs>, T, "update">,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends AppUserUpsertArgs>(
      ...
      $Result.GetResult<Prisma.$AppUserPayload<ExtArgs>, T, "upsert">,
      never,
      ExtArgs
    >;
  ...
  interface AppUserFieldRefs {
    ...
    readonly admin: FieldRef<"AppUser", "Boolean">;
    readonly isEmailVerified: FieldRef<"AppUser", "Boolean">;
  }
  ...
  export type AppUserWhereInput = {
    ...
    admin?: BoolFilter<"AppUser"> | boolean;
    isEmailVerified?: BoolFilter<"AppUser"> | boolean;
  };
  ...
  export type AppUserScalarWhereWithAggregatesInput = {
    AND?:
      | AppUserScalarWhereWithAggregatesInput
      | AppUserScalarWhereWithAggregatesInput[];
    ...
    admin?: BoolWithAggregatesFilter<"AppUser"> | boolean;
    isEmailVerified?: BoolWithAggregatesFilter<"AppUser"> | boolean;
  };
