...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      Work: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.WorkFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.WorkAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export interface WorkDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * })
     */
    findRaw(args?: WorkFindRawArgs): Prisma.PrismaPromise<JsonObject>
     ...
     * })
     */
    aggregateRaw(args?: WorkAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  export interface Prisma__WorkClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    reviews<T extends Work$reviewsArgs<ExtArgs> = {}>(args?: Subset<T, Work$reviewsArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ReviewPayload<ExtArgs>, T, "findMany"> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface WorkFieldRefs {
    ...
    readonly genre: FieldRef<"Work", 'String[]'>
    readonly releaseDate: FieldRef<"Work", 'DateTime'>
    readonly rating: FieldRef<"Work", 'Float'>
    readonly votesCount: FieldRef<"Work", 'Int'>
  }
   ...
   * Work findRaw
   */
  export type WorkFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
   ...
   * Work aggregateRaw
   */
  export type WorkAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type WorkWhereInput = {
    ...
    genre?: StringNullableListFilter<"Work">
    releaseDate?: DateTimeFilter<"Work"> | Date | string
    rating?: FloatFilter<"Work"> | number
    votesCount?: IntFilter<"Work"> | number
    reviews?: ReviewListRelationFilter
  }
  ...
  export type WorkScalarWhereWithAggregatesInput = {
    ...
    genre?: StringNullableListFilter<"Work">
    releaseDate?: DateTimeWithAggregatesFilter<"Work"> | Date | string
    rating?: FloatWithAggregatesFilter<"Work"> | number
    votesCount?: IntWithAggregatesFilter<"Work"> | number
  }
  ...
  export type WorkCreateInput = {
    ...
    title: string
    type: string
    genre?: WorkCreategenreInput | string[]
  ...
  export type WorkUpdateInput = {
    ...
    genre?: WorkUpdategenreInput | string[]
  ...
  export type WorkCreategenreInput = {
    set: string[]
  }
  ...
  export type WorkUpdategenreInput = {
    set?: string[]
    push?: string | string[]
  }
